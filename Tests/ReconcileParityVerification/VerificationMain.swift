...
enum ReconcileParityVerification {
    ...
    private static func printDemoTables() {
        ...
        print("")
        let wrong = ReconcileResponse.HostnameStats(hostname: "mbp-work", bucketCount: 2, sessionCount: 3, totalTokens: 1457, totalCostCents: 137, firstBucketAt: first, lastBucketAt: last, lastSyncedAt: last)
